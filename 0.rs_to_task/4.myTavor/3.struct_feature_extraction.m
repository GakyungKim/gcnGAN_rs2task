...
%   Sulcal depth
%   Cortical thickness
%   Myelin Map (T1w/T2w ratio)
%   Diffusion features
%
% S.Jbabdi 04/2016 -> Betty 08/2021

% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TO-BE-EDITED: Replace the below with your own
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%datadir='/vols/Scratch/HCP/Structural/Q123'; 
outdir='/Users/bettybetty3k/Library/Mobile Documents/com~apple~CloudDocs/connectome21/2021-1/project/GAN/outdir';
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
