...
SUBJECT_PATH=/scratch/bigdata/hcp1200 #path to HCP subject IDs
OUTPUT_DIR=/scratch/bigdata/hcp1200/output #path to OUTdir

SUBJECT=$SUBJECT_PATH/sublist_hcp1200.txt
